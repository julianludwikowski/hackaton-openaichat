    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Spytaj swoje dane</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput
                        placeholder="Przykład: Czy możliwe jest przeniesienie kredytu do Alior Banku?"
                        disabled={isLoading}
            ...
            <div className={styles.oneshotBottomSection}>
                {isLoading && <Spinner label="Generuję odpowiedź" />}
