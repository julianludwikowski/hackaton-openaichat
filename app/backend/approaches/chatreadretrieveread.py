...
#If the question is not in English, translate the question to English before generating the search query. 
    ...
    query_prompt_few_shots = [
        ...
        {'role' : USER, 'content' : 'Jak zawnioskować o Alior Pay?' },
        {'role' : ASSISTANT, 'content' : 'Alior Pay to usługa oferowana przez Alior Bank, która umożliwia klientom korzystanie z dodatkowego limitu kredytowego na koncie osobistym. Decyzja o przyznaniu limitu kredytowego Alior Pay oraz jego wysokość zależą od zdolności kredytowej klienta. Aby zawnioskować o ten dodatkowy limit, należy skontaktować się z bankiem i przedstawić swoje potrzeby oraz zdolność kredytową.' },
