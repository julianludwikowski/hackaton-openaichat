...
"""
    ...
    async def run(self, q: str, overrides: dict[str, Any]) -> Any:
        ...
        top = overrides.get("top") or 6 #zmienione
        ...
        if overrides.get("semantic_ranker") and has_text:
            r = await self.search_client.search(query_text,
                                          ...
                                          query_language="pl-PL", # tutaj zmienione 4 Sept 9:29
                                          #query_speller="lexicon",
                                          semantic_configuration_name="default",
                                          top=top,
                                          query_caption="extractive|highlight-false" if use_semantic_captions else None,
                                          vector=query_vector,
                                          top_k=50 if query_vector else None, # tutaj zmienione 4 Sept 9:29
        ...
        chat_completion = await openai.ChatCompletion.acreate(
            ...
            messages=messages,
            temperature=overrides.get("temperature") or 0.2, # tutaj zmienione 4 Sept 9:29
            max_tokens=1024,
            top_p=0.8, # tutaj zmienione 4 Sept 9:29
            n=1)
